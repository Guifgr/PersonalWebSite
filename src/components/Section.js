    ...
    return (
        <section style={theSection}>
            ...
            <h5 style={h1}>
                Check{" "}
                <a
                    href="https://developer.mozilla.org/pt-BR/docs/Web/JavaScript/Reference/Operators/this"
                    target="_blank"
            ...
            <div className="full" style={theImgDiv}>
                <a className="full" href="http://imperiodaspalmeiras.com.br/">
                    <img
                        className="full"
                        alt="imperioDasPalmeiras"
                        src={imperioDasPalmeiras}
                        style={Img}
                    ></img>
                </a>
            ...
            >
                <h5 style={h5}>
                    Ir para meu Github!{" "}
                    <svg style={{ height: "20px" }} viewBox="0 0 496 512">
                        <path
                            fill="currentColor"
